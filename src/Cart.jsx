  ...
  return (
    ...
    <div className='w-full h-full flex flex-wrap'>
    ...
    
      {
              ...
              cart.map((dame ,k) => ( 
                <div key={k} className='w-full sm:w-1/2 justify-center md:w-1/3 lg:w-1/4 p-10 transition duration-500 ease-in-out transform scale-75 hover:fill-white hover:scale-90 border border-gray-900 mt-11 sm:justify-center'> 
